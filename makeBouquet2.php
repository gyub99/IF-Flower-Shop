        ...
        <div class="choosing col-sm-6">
          ...
          <div class="row">
              ...
              <div class="col-sm-3 choose-flower">
                <button type="button" id="button1" class="select-flower"><a href="flower_making_process.php?id=<?php echo $row['custom_flower_id'] ?>"><img class="img-responsive" src="<?php echo $row["custom_flower_image"]?>" alt="flower1"/>
