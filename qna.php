...
<html>
  ...
  <body>
    ...
    $id='';
    //$id=$_GET['product_id'];
    $all_qna=$mysqli->query("SELECT * FROM qna ORDER BY question_id DESC") or die($mysqli->error);
    ?>
  ...
  <nav class="navbar navbar-default">
    ...
    <div class="container contents">
      <div class="title">
        ...
        <h5 class="">질문을 등록하고 답변을 받으세요</h5>
      </div>
      <div class="justify-content-center">
      <table class="table">
          <tr style="border-top:2px solid #90c8ac; border-bottom:2px solid #90c8ac;">
            <th class="qnaid"></th>
            <th class="userid">질문자 ID</th>
            <th class="qnacontent">질문 내용</th>
          </tr>
        <?php
          while($row=$all_qna->fetch_assoc()):
         ?>
         <tr>
           <td class="qnaid"><?php echo $row['question_id']; ?></td>
           <td class="userid"><?php echo $row['user_id']; ?></td>
           <td class="qnacontent"><a href="qna_contents.php?no=<?php echo $row['question_id']?>"><?php echo $row['question_contents']; ?></a></td>
         </tr>
       <?php endwhile; ?>
      </table>
    </div>
    <div class="write-qna">
      <a class="write-button" href="write_qna.php">글쓰기</a>
    </div>
    </div>
